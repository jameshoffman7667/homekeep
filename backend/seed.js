module.exports = {
  locations: [
    { id: "loc_house", name: "Main House", level: "Property", parentId: null },
    { id: "loc_f1", name: "1st Floor", level: "Floor", parentId: "loc_house" },
    { id: "loc_f2", name: "2nd Floor", level: "Floor", parentId: "loc_house" },
    { id: "loc_util", name: "Utility Room", level: "Room", parentId: "loc_f1" },
    { id: "loc_kitchen", name: "Kitchen", level: "Room", parentId: "loc_f1" },
    { id: "loc_bath", name: "Primary Bathroom", level: "Room", parentId: "loc_f2" },
    { id: "loc_garage", name: "Garage", level: "Structure", parentId: null },
  ],
  assets: [
    { id: "a_furnace", name: "Furnace", category: "HVAC", locationId: "loc_util", manufacturer: "Carrier", model: "58STA080", serial: "SN-2019-4471", purchaseDate: "2019-10-02", warrantyEnd: "2029-10-02", notes: "Installed with new ductwork." },
    { id: "a_wh", name: "Water Heater", category: "Plumbing", locationId: "loc_util", manufacturer: "Rheem", model: "XE50T10H45U0", serial: "SN-2021-0092", purchaseDate: "2021-03-14", warrantyEnd: "2027-03-14", notes: "" },
    { id: "a_fridge", name: "Refrigerator", category: "Appliance", locationId: "loc_kitchen", manufacturer: "LG", model: "LRFVS3006S", serial: "SN-2022-7761", purchaseDate: "2022-01-11", warrantyEnd: "2024-01-11", notes: "" },
    { id: "a_car", name: "Honda CR-V", category: "Vehicle", locationId: "loc_garage", manufacturer: "Honda", model: "CR-V EX-L", serial: "1HGCM82633A004352", purchaseDate: "2022-06-01", warrantyEnd: "2025-06-01", notes: "" },
  ],
  bomNodes: [
  ...
  vendors: [
    { id: "v_hvac", name: "Cool Air HVAC Co.", specialty: "HVAC", contact: "(555) 019-2231", notes: "Same-day emergency calls." },
  ],
  inventory: [
